...
```{r m-total,  fig.show="hold", out.width="50%", fig.height=4.5, fig.cap= "Total Letters Per Year", fig.subcap= c("cross-sectional","diff-in-diff","cross-sectional re-elected","diff-in-diff re-elected")}
testing = F
