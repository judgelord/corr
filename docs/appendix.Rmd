...
<table class="tg"><thead>
  <tr>
    <th class="tg-0pky"></th>
    <th class="tg-0pky">Sufficient increase in capacity</th>
    <th class="tg-0pky">Insufficient change in capacity</th>
  </tr></thead>
<tbody>
  <tr>
    <td class="tg-0pky">Priority shifts <br> to policy work</td>
    <td class="tg-0pky">Level of Service: $0$ or $\uparrow$<br>Ratio of $\frac{\textrm{policy}}{\textrm{service}}$: $\uparrow$</td>
    <td class="tg-0pky">Level of Service: $\downarrow$<br>Ratio of $\frac{\textrm{policy}}{\textrm{service}}$: $\uparrow$</td>
  </tr>
  <tr>
    <td class="tg-0pky">No change<br>in priorities</td>
    <td class="tg-0pky">Level of service: $\uparrow$<br>Ratio of $\frac{\textrm{policy}}{\textrm{service}}$: $0$</td>
    <td class="tg-0pky">Level of service: $0$<br>Ratio of $\frac{\textrm{policy}}{\textrm{service}}$: $0$</td>
  </tr>
</tbody></table>
...
FOIA |>
  dplyr::select(-Coded) |>
  dplyr::rename(N = Observations) |> 
  write.csv(file = here::here("docs", "tables", "FOIA.csv"),
          row.names = F) 
```
...
all_contacts2$Type %<>% str_replace("Indiv. Constituent" , "Constituent (individual)") %>% 
  ...
  str_replace("501c3 or Local Gov." , "Constituent (501c3 or local\n government)")%>% 
...
write(sum(type2020$n), file = here::here("docs", "tables", "n2007-2020"))
...
coded %>% filter(coded) %>% .$n |> write(file = here::here("docs", "tables", "n2007-2020coded"))
...
ggsave(here::here("figs/counts-per-year.pdf"), p, height=3.5, width=5.7)
```   
