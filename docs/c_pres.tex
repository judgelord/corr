...
\begin{footnotesize}
\input{../tables/TablePrestige.tex}
\end{footnotesize}
...
\only<1>{
\begin{scriptsize}
\input{../tables/TypeContact_tenure.tex}
\end{scriptsize}
}

\only<2>{
\begin{scriptsize}
\input{../tables/TypeContact_prestige.tex}
\end{scriptsize}
}
...
%\input{../tables/TableNameRec_Tenure.tex}
%\end{scriptsize}}

%\only<2>{\begin{scriptsize}
%\input{../tables/TableNameRec_Prestige.tex}
%\end{scriptsize}}
