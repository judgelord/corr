...
# #TODO get this from github? hard code it? 
# foia_requests <- readLines(here::here("tables", "foia_requests"))

n2007_2020 <- dcounts_tenure$perYear |> sum()
n2007_2020coded <- sum(dcounts_tenure$perYear_con, dcounts_tenure$perYear_policy)
 
n_agency <- dcounts_tenure$agency |> unique() |> length()

save(mean_total, mean_con, mean_pol, n_agency, #foia_requests, 
     n2007_2020, n2007_2020coded, 
