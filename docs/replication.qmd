...
m_district_con_cross <- feglm(perYear ~
  new_member + 
  second_year + third_year + fourth_year + fifth_year + sixth_year | Year,
cluster = "District",
data = dcounts_per_district)
...
m_district_con_cross_party <- feglm(perYear ~
  new_member*same_party + 
  second_year*same_party + third_year*same_party + fourth_year*same_party + fifth_year*same_party + sixth_year*same_party | Year,
cluster = "District",
data = dcounts_per_district)
...
# Diff in diff
m_district_con_dnd <- feglm(perYear ~
  new_member + #same_party + 
  second_year + third_year + fourth_year + fifth_year + sixth_year | 
    District + Year,
cluster = "District",
...
# Diff in diff
m_district_con_dnd_party <- feglm(perYear ~
  new_member*same_party + 
  second_year*same_party + third_year*same_party + fourth_year*same_party + fifth_year*same_party + sixth_year*same_party | 
    District + Year,
cluster = "District",
...
# Diff in diff
m_district_con_dnd_house <- feglm(perYear ~
  new_member + #same_party + 
  second_year + third_year + fourth_year + fifth_year + sixth_year | 
    District + Year,
cluster = "District",
...
# Diff in diff + party change var 
m_district_con_dnd_house_party <- feglm(perYear ~
  new_member*same_party + 
  second_year*same_party + third_year*same_party + fourth_year*same_party + fifth_year*same_party + sixth_year*same_party | 
    District + Year,
cluster = "District",
...
# Diff in diff
m_district_con_dnd_senate <- feglm(perYear ~
  new_member + #same_party + 
  second_year + third_year + fourth_year + fifth_year + sixth_year | 
    District + Year,
cluster = "District",
...
# Diff in diff + party change var 
m_district_con_dnd_senate_party <- feglm(perYear ~
  new_member*same_party + 
  second_year*same_party + third_year*same_party + fourth_year*same_party + fifth_year*same_party + sixth_year*same_party | 
    District + Year,
cluster = "District",
...
modelsummary::modelsummary(models_district, # stars = T, 
             add_rows = rows,               
             coef_map = cm, 
             gof_map = gm, 
