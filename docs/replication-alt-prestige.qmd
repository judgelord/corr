...
members %<>% mutate(prestige2 = ifelse(
                      str_detect(committees, "JUDICIARY|FINANCIAL SERVICES"),
                      1,
                      prestige),
                    prestige_chair2 = ifelse(
                      str_detect(chair_of, "JUDICIARY|FINANCIAL SERVICES"),
                      1,
                       prestige_chair) )

dcounts_tenure %<>% left_join(members %>% distinct(icpsr, congress,prestige2, prestige_chair2))

dcounts_ratio %<>% left_join(members %>% distinct(icpsr, congress, prestige, prestige_chair, prestige2, prestige_chair2))
...
cm = c("chair" = "Committee Chair",
       "ranking_minority" = "Ranking Member",
              "prestige2" = "Prestige Committee (alt)",
...
m_total_cross <-feglm (perYear ~ 
                         chair + ranking_minority + prestige2 + 
...
m_ratio_cross <- feglm(ratio ~
  chair + ranking_minority + prestige2 + majority +  presidents_party + 
