...
```{r, out.width="80%"}
include_graphics("docs/figs/pop-1.png")
```
...
```{r, out.width="80%"}
include_graphics("docs/figs/percentiles-1.png")
```
...
```{r}
include_graphics("docs/figs/districts/(WI-07)-map.png")
```
...
```{r}
include_graphics("docs/figs/districts/(WI-07).png")
```
...
```{r}
include_graphics("docs/figs/districts/(WI).png")
```
