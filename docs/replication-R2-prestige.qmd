---
title: "Replication Using R2's Suggested Prestige Committees"
...
- Figures: `figs/m-R2-total-[1:4].png`
...
m_total_cross <-feglm (perYear ~ 
                         chair + ranking_minority + prestigeR2 + 
...
- Figures: `figs/m-R2-total-predicted-[1:4].png`


```{r}
#| label: "m-R2-total-predicted"
...
- Figures: `figs/m-R2-con-[1:4].png`

```{r}
#| label: "m-R2-con"
#| fig-cap: "figs/m-R2-con-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
- Figures: `figs/m-R2-policy-[1:4].png`

```{r}
#| label: "m-R2-policy"
#| fig-cap: "figs/m-R2-policy-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
- Figures: `figs/m-R2-policy-predicted-[1:4].png`

```{r}
#| label: "m-R2-policy-predicted"
...
- Figures: `figs/m-R2-ratio-[1:2].png`

```{r}
#| label: "m-R2-ratio"
#| fig-cap: "figs/m-R2-ratio-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
m_ratio_cross <- feglm(ratio ~
  chair + ranking_minority + prestigeR2 + majority +  presidents_party + 
...
- Figures: `figs/m-R2-ratio-predicted-[1:4].png`

```{r}
#| label: "m-R2-ratio-predicted"
