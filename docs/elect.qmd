...
dcounts_ratio %<>% left_join(members)
load(here::here("data", "dcounts_per_district.Rdata"))
dcounts_per_district %<>% left_join(members)
...
# check N
dcounts_tenure %>% tally(perYear)
dcounts_ratio %>% tally(perCon)
dcounts_ratio %>% tally(perPol)
dcounts_per_district %>% ungroup %>%  tally(perYear)
