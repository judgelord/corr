---
title: "Replication Using Our Original Prestige Committees"
...
# inspect 
# members |> distinct(chamber, committees, prestigeOLD, prestigeOLD, prestige) %>% kablebox_long()

#FIXME? We have some missing committee data, even during our main analysis periood of 2007-2020
# members |> count(is.na(committees)) |> kable() 
# members |> filter(is.na(committees), congress > 109)
...
dcounts_tenure %<>% left_join(members %>% distinct(icpsr, congress,  prestige,  prestigeR2, prestigeOLD))

dcounts_ratio %<>% left_join(members %>% distinct(icpsr, congress, prestige, prestigeR2, prestigeOLD))
...
- Figures: `figs/m-old-total-[1:4].png`
...
m_total_cross <-feglm (perYear ~ 
                         chair + ranking_minority + prestigeOLD + 
...
- Figures: `figs/m-old-total-predicted-[1:4].png`


```{r}
#| label: "m-old-total-predicted"
...
- Figures: `figs/m-old-con-[1:4].png`

```{r}
#| label: "m-old-con"
#| fig-cap: "figs/m-old-con-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
- Figures: `figs/m-old-policy-[1:4].png`

```{r m-policy}
#| label: "m-old-policy"
#| fig-cap: "figs/m-old-policy-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
- Figures: `figs/m-old-policy-predicted-[1:4].png`

```{r}
#| label: "m-old-policy-predicted"
...
- Figures: `figs/m-old-ratio-[1:2].png`

```{r}
#| label: "m-old-ratio"
#| fig-cap: "figs/m-old-ratio-[1:4].png"
#| layout-ncol: 2
#| fig-height: 4.5
#| fig-subcap: 
#|   - "1"
...
m_ratio_cross <- feglm(ratio ~
  chair + ranking_minority + prestigeOLD + majority +  presidents_party + 
...
- Figures: `figs/m-old-ratio-predicted-[1:4].png`

```{r}
#| label: "m-old-ratio-predicted"
