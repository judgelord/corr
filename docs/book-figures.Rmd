...
t <- tibble(
  ...
  Overall = map2_chr(list(n$n), ns, cor),
  Type1 = map2_chr(list(n1$n1), ns, cor),
  Type2 = map2_chr(list(n2$n2), ns, cor),
  Type3 = map2_chr(list(n3$n3), ns, cor),
  Type4 = map2_chr(list(n4$n4), ns, cor),
    Type5 = map2_chr(list(n5$n5), ns, cor)
)
