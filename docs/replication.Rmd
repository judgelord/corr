...
modelsummary(models_total, # stars = T, 
             ...
             notes = list("\\\\footnotesize Robust standard errors in parentheses, clustered by legislator."))   %>%  format_table()  %>% write_lines(file = here::here("docs", "tables", "models_total.tex") )
