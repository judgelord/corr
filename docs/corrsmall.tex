...
To assess how institutional power shapes behavior, we assemble a massive new database of \input{tables/n} legislator requests to a near census of departments, agencies, and sub-agencies between 2007 and 2020.
...
Word Count: 9649 % abstract = 150 (as of 4-25-2024) 
...
To address potential confounding, Model 2 (Column 2 of Table \ref{t:models_total}) shows the difference-in-differences specification in Equation \ref{e:diff1}. Across all measures of institutional power, we find that acquiring power increases the number of requests that a given legislator makes. Becoming a committee chair causes an increase of 0.27 requests \textit{per agency} (95-percent confidence interval [0.09, 0.45]). Across all \input{tables/n_agencies} agencies, this represents an increase of approximately 24 additional requests per year, a 24\% increase over the average number of requests. There is a smaller increase for individuals who become ranking members and those who join a Prestige Committee, though the increase is statistically significant for joining a prestige committee. %Becoming a ranking member of a committee causes an increase of 0.15 contacts per agency while joining a prestige committee causes a 0.27 per agency increase in the number of contacts a legislator makes. Across all \input{tables/n_agencies} agencies in these data, this represents an increase of approximately 14 and 24 additional requests per year, respectively. Given the overall average of 72 letters per year, these differences are substantial. 
