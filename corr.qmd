...
::: {#tbl-theory}
+---------------+--------------------------+--------------------------+
|               | **Sufficient increase in | **Insufficient change in |
|               | capacity**               | capacity**               |
+:==============+:=========================+:=========================+
| **Priority    | -   Level of service:    | -   Level of service:    |
| shifts** **to |     $0$ or $\uparrow$    |     $\downarrow$         |
| policy work** | -   Ratio of             | -   Ratio of             |
|               |     $\frac{\textrm{poli  |     $\frac{\textrm{poli  |
|               | cy}}{\textrm{service}}$: | cy}}{\textrm{service}}$: |
|               |     $\uparrow$           |     $\uparrow$           |
+---------------+--------------------------+--------------------------+
|               |                          |                          |
+---------------+--------------------------+--------------------------+
| **No change** | -   Level of service:    | -   Level of service:    |
| **in          |     $\uparrow$           |     $0$                  |
| priorities**  | -   Ratio of             | -   Ratio of             |
|               |     $\frac{\textrm{poli  |     $\frac{\textrm{poli  |
|               | cy}}{\textrm{service}}$: | cy}}{\textrm{service}}$: |
|               |     $0$                  |     $0$                  |
+---------------+--------------------------+--------------------------+
