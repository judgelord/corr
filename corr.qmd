...
with legislator requests may help agencies achieve their own goals. If agency staff aim to grow their coalition of political supporters, we expect
...
The bottom left cell of @tbl-theory shows our expectations if only capacity increases but priorities remain unchanged (Subfigure a of @fig-2x2). 
The top right cell of @tbl-theory shows our expectations if only priorities change and capacity remains unchanged (Subfigure b of @fig-2x2) or insufficiently changed (any outcome in the lower, lighter-shaded region of @fig-2x2, Subfigure d) to compensate for a given magnitude of priority shift. 
...
result of legislators' capacity and experience. While variation in
...
examining how an individual legislator's rates of contact vary over time
...
constituents redirect their requests toward legislators whom they see as more powerful. Constituents might expect that more powerful
...
state's delegation. To address these sorts of concerns,
...
Upon receiving records of congressional requests, we extracted names from the text
...
averaged 54 contacts with federal agencies per year. 
...
The model also accounts for the different
...
members, and members of prestige committees make substantially more requests than other legislators. However, these cross-sectional differences may be the result of other legislator
...
To address potential confounding, Models 2-4 (Columns 2-4 of @tbl-models-total)
...
Other measures of institutional power included in these models (ranking minority member and prestige committee member) are also associated with increased levels of contact with federal agencies, but these effects are only significant at the .05 level in the cross-sectional model (Models 1), and, for ranking member, in the difference in differences design with the logged number of contacts as the dependent variable (Model 4). Because we estimate the effects of becoming a committee chair and being a member of a prestige committee in the same model, these effects are additive: prestige committee chairs may make more requests than non-prestige committee chairs who make more requests than non-chairs. 

Evidence about the effects of majority party status or having a co-partisan president is less conclusive. Majority party status is negatively associated with contacting agencies only in Models 1 and 4. Having a co-partisan president is negatively associated with contacting agencies on average (Model 1), but gaining a co-partisan president leads to making more requests in all models of within-legislator variation.
...
## The Effect of Electing a New Representative {#sec-district}
 ...
 We found that as legislators acquire more power, they contact agencies more. In this section we show that legislators also increase their capacity as they gather experience in the institution.  Rather than examining changes in the number of requests by making
...
[^7]: Despite showing nearly identical results, within-district analysis is fundamentally different than within-legislator analysis. In each election, each district allows its incumbent to acquire another term or replaces them. This differs from within-legislator comparisons
...
quickly. Districts have significantly fewer requests made on their behalf when they are represented by a legislator in their second year, but not as drastic as the difference observed in the first year. After the
...
use the `r n2007_2020coded` hand-coded requests described in @sec-data. The dependent variable
...
work as they obtain experience and powerful positions in Congress. 
...
The first column of @tbl-models-ratio shows how the
...
acquired.
Subfigure *b* shows predictions for counterfactuals where the same legislator did and did not receive a chair position in their sixth year. There is a significant difference when members gain a committee chair position and when they gain more than three years of experience. 
Notably, whether a member has a co-partisan president does not cause a significant difference.
...
Increasing capacity and shifting priorities are not mutually exclusive. 
When legislators acquire capacity, they make more requests of federal agencies.  
At the same time, higher capacity legislators allocate a relatively larger share of their efforts towards policy work.  
In this section, we show that the net result of these two simultaneous effects in our time period (2007-2020) is that more experienced and powerful legislators did not decrease their *levels* of constituency service, even though they allocated a larger *share* of their attention towards policy.    
...
shifts do not appear to explain the within-legislator or within-district variation we observe with changing committee positions and longer tenure in Congress. We show that constituent demand does not shift
...
overall number of legislator requests. <!-- and that constituency characteristics---the proportion of veterans and the proportion over 65---correlate with the
distribution of requests across agencies. --> 
...
district characteristics. Given this potential confounding, our models
above leveraged within-district and within-agency variation.
...
more powerful or who have served longer (holding constant legislators' levels of soliciting
...
demand to explain our results). In that case, we should observe them redirecting their
