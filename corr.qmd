...
n_agency <-  readLines(here::here("docs", "tables", "n_agencies"))
```
...
constituency service to decrease by about 40%, or `r -beta$new_member` letters per year
...
much less policy work and constituency service. Legislators in their first year and second year contact federal agencies significantly less than legislators serving longer than six years. Further, when
...
## Experienced and Powerful Legislators Send Relatively Fewer Constituent Requests, But Maintain the Same Level of Service {#sec-priority}
...
Taken together, our ratio results from this section and the level results from the previous section show that as legislators acquire more power their contacts with the bureaucracy become more policy focused. 

We have shown that as legislators acquire more power they make more contacts with the bureaucracy and those contacts become relatively more policy focused. Taken together our results show that the total number of constituency service requests do not drop, even as the proportion of requests that are constituency service related decreases. <!--We can see that from these two sets of analyses by recalling that in the difference-in-difference specification of our level analysis (Model 2 of Table 2) we found that becoming a committee chair causes an increase of 0.29 requests per agency (95-percent confidence interval [0.12,0.47]). Across all 92 agencies, this represents an increase of approximately 27 additional requests per year.--> <!--TODO INSERT EVIDENCE FOR THIS --> 
