...
legislators gain power and experience, they should decrease their ratio of
...
power, even as their ratio of constituent service to policy work
decreases. Alternatively, if the effect of increased capacity is
...
of constituency service and the ratio of constituency service to policy work  due to *changes in capacity* and *shifting priorities*. The top-left cell of @tbl-theory shows our expectations if both mechanisms
...
|  **to policy work**       | -   $\Delta$ Ratio of $\frac{\textrm{service}}{\text{policy}}$: $\uparrow$ | -   $\Delta$ Ratio of $\frac{\textrm{service}}{\text{policy}}$: $\uparrow$ |
+---------------------------+----------------------------------------------------------------------------+----------------------------------------------------------------------------+
|                           |                                                                            |                                                                            |
+---------------------------+----------------------------------------------------------------------------+----------------------------------------------------------------------------+
...
constituency service to policy work.[^4]
...
effect of institutional power on legislator behavior. First, @sec-capacity tests
theories rooted in legislator capacity by modeling the effects of
institutional power on a legislator's total number of requests to federal agencies. 
Next, @sec-prioirty test theories rooted in legislators' priorities by
modeling the effects of institutional power on a legislator's *ratio* of
constituency service to policy work.
@sec-joint then examine the impact of power and experience on a legislator's *level* of constituency service, showing that increasing capacity allows legislators to maintain levels of constituency service even as they prioritize policy work.

## The Effect of Expiernece and Power Institutional on Legislator Capacity {#sec-capacity}
...
[^5]: We drop ten member-year level observations where members switched chambers mid-congress.
...
### More Expiernced and Powerful Legislators Make More Requests to Federal Agencies
...
## The Effect of Expiernece and Institutional Power on Legislator Priorities {#sec-priority}
...
work as they obtain more prestigious committee
...
Taken together, these findings about how the ratio of constituency service to policy work varies across legislators show that as legislators acquire more experience and power, their contacts with the bureaucracy become more policy-focused. 
