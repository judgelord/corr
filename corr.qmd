...
legislators. We had sufficient information on `r n2007_2020coded` of these contacts to hand-code for whether they focus on constituency service or policy. Models discussed in @sec-capacity and @sec-district use the full sample. Models discussed in @sec-priority and @sec-joint use the hand-coded sample. 
...
institutional power on a legislator's total number of requests to federal agencies. Next, we test theories rooted in legislators' priorities by
modeling the effects of institutional power on a legislator's *ratio* of
policy work to constituency service before examining the impact on a legislator's *level* of constituency service.
...
year, more than a 20% increase over the average requests per year in our data.

Other measures of institutional power included in these models (ranking minority member and prestige committee member) are associated with similar increased levels of contact with federal agencies, but these effects are only significant at the .05 level in the cross-sectional and difference in differences design with the logged number of contacts as the dependent variable (Models 1 and 4). It is worth noting that because we estimate the effects of becoming a committee chair and being a member of a prestige committee in the same model, these effects are additive: prestige committee chairs may make more requests than non-prestige committee chairs who make more request than non-chairs. 

Our evidence about the effects of majority party status or having a co-partisan president is less conclusive. Majority party status is negatively associated with contacting agencies only in Models 1 and 4. Having a co-partisan president is negatively associated with contacting agencies on average (Model 1), but positively associated with contacting agencies in the all models of within-legislator variation.
...
We now turn to a related question: how does a district's overall representation (capacity in the form of total contacts with federal agencies) change after the election of a new representative? We found that as legislators acquire more power, they contact agencies more. In this section we show that legislators also increase their capacity as they gather experience in the institution.  Rather than examining changes in the number of requests by making
...
## Constituent Service Requests are a Smaller Proportion of the Work of Experienced and Powerful Legislators {#sec-priority}
