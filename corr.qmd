...
journal:
  blinded: false
wordcount: 10,000 # 9511 words in text body... Add 449 to the word count for figure and table captions (unless we can cut figure and table captions)
format:
  #html
  docx
  # cmc-article-pdf:
...
agencies. Since 2016, Gini coefficients for inequality in the number of contacts per year among members of each chamber range between 0.56 and 0.90, exceeding the Gini coefficient for income inequality in every country the World Bank reported in 2023. To visualize this variation, @fig-contact1 shows the average number of contacts per year for House members (panel (a)) and
senators (panel (b)).[^5] 
...
knitr::include_graphics("docs/figs/percentiles-chamber-1.png")
knitr::include_graphics("docs/figs/percentiles-chamber-2.png")
```
