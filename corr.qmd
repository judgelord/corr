...
distributive politics [@MillsKalafHuges2015], 
money in politics [@Powell2023FERC], <!-- legislators who receive more campaign donations from fossil fuel companies are more likely to intervene to support those companies --> 
and the role of ideology in congressional oversight [@Lowande2018JOP].
Except for work by @LowandeRitchieLauterbach2018 on descriptive representation, this
...
To assess absolute and relative shifts in legislator contacts to agencies, we hand-code the content of `r n2007_2020coded` (of our total  `r n2007_2020`) requests as policy work or constituency service. Doing so also yields many illuminating descriptives about modern legislator behavior. For example, over 80% of contacts are made on behalf of constituents, and less than 20% are focused on policy work.
...
legislators. We were able to hand-code `r n2007_2020coded` for whether they focus on constituency service or policy. Models discussed in @sec-capacity and @sec-district use the full sample. Models discussed in @sec-priority and @sec-joint use the hand-coded sample. 
