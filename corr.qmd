...
journal:
  blinded: false
wordcount: 10170 # Add 440 to word count for figure and table captions (unless we can cut figure and table captions)
format:
  #html
  #docx
  cmc-article-pdf:
...
that constituents shift demands to more established legislators when a new
...
A related literature similarly finds that seniority and committee
...
political science literature on Congressional careers.
Different institutional positions allow legislators to advance different goals [@Fenno1973].
Legislators do not only care about reelection; they also
...
As legislators spend more time in Washington, they also may become detached from their district. 
...
of the shift toward prioritizing policy work is
...
policy work in Washington, the ratio of constituency service to policy work to  will decrease. 
...
If legislators' priorities shift
...
magnitude of shift in priorities. Increased capacity may offset a
...
[@StewartWoon2017], and committee oversight [@LewisSelin2012].^[Our
...
Before testing theories of how legislator behavior changes as they acquire experience and power, we
...
<!--
A few examples high contact senators , Senator Byrd (D-WV) averaged 538
...
quickly. Districts have significantly fewer requests made on their behalf when they are represented by a legislator in their second year, but not as drastic as the difference observed in the first year. After the second year, the differences are smaller. This phenomenon---new
...
Increasing capacity and shifting priorities are not mutually exclusive. When legislators acquire capacity, they make more requests of federal agencies. At the same time, higher capacity legislators allocate a larger share of their efforts towards policy work. In this section, we show that the net result of these two simultaneous effects from 2007 to 2020 was that more experienced and powerful legislators did not decrease their *levels* of constituency service, even though they allocated a larger *share* of their attention towards policy.    
