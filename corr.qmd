...
journal:
  blinded: false
wordcount: 10346 # 10068 excluting table notes
format:
  #html
  #docx
  cmc-article-pdf:
...
While constituent demand affects the level of constituency service that members provide, demand-side shifts do not appear to explain the within-legislator or within-district variation we observe with changing committee positions and longer tenure in Congress.
...
larger states provide more service on average. Senators
from larger states average more requests per year than legislators from
...
investigates whether additional constituent demand could plausibly
