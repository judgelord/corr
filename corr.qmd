...
distributive politics [@MillsKalafHuges2015], and the role of ideology in congressional oversight [@Lowande2018JOP].
...
work as they obtain experience and powerful positions in Congress. While the ratio of constituency service to policy work is conditional on
...
Subfigure *b* shows predictions for counterfactuals where the same legislator did and did not receive a chair position in their sixth year. There is a significant difference when members gain a committee chair position. Notably, whether a member has a co-partisan president does not cause a significant difference.
...
# Robustness Check: The Effects of Demand for Constituency Service {#sec-demand}
...
At the same time, we document massive inequities in the levels of service and policy work that members provide. This variation is even greater than can be explained by the substantively large effects of experience and power, suggesting that the "service-policy divide" [@ButlerKarpowitzPope2012] offers an incomplete picture of how legislators use their capacity. 
...
While we've focused on understanding the impact of experience and institutional power in this paper, many questions remain ripe for future research. On this same topic, future research should delved into the mechanisms by which
...
Perhaps the most pressing unexplored question is explaining the massive inequities in the levels of service and policy work that members provide that we've documented here. Why do some legislators provide so much constituency service and other legislators so little? As we've noted previously, this inequality is well beyond what could be explained by the power and experience. 
