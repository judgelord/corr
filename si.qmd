...
## Congressional Correspondence Log Coding Guidelines
...
modelsummary::modelsummary(models_con,  
             stars = c('†' = .1, '*' = .05, '**' = .01), 
             add_rows = rows,               
             coef_map = cm, 
             gof_map = gm, 
...
modelsummary::modelsummary(models_district_party,  
             ...
             output = "tinytable",
             coef_omit = coef_omit, 
             notes =  "This table shows how constituent service at the district level changes over time. Model 1 is a cross-sectional comparison excluding district and year fixed effects. The second column is a district x year difference in differences model. Column 3 focuses is the diff-in-diff subsetted to legislators who survive their first election."
)
```
...
```{r}
#| fig-cap: "Predicted Number of Total Letters per District) 2007-2018"
