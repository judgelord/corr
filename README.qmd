...
For additional variables that are part of the broader data from this project but not required to replicate the analysis for this paper, including data on oversight relationships and agency characteristics from @LewisSelin2012, please contact the authors. 
